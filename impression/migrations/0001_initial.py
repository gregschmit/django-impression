# Generated by Django 2.0 on 2019-12-30 06:25
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="forbid",
                        help_text="Whether the message body must (require), may (permit), or may not (forbid) be decoded as a JSON and loaded into template context.",
                        max_length=255,
                        verbose_name="JSON body policy",
                    ),
                ),
                (
                    "allowed_groups",
